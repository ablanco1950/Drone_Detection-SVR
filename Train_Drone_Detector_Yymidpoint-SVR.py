...
dirname="Drone-Detection-data-set(yolov7)-1\\train\\images"
dirnameLabels="Drone-Detection-data-set(yolov7)-1\\train\\labels"

imageSize=64  # from 640
...
pickle.dump(svr_lin,open("svr_lin_Drone_Detector_Yymidpoint.pickle",'wb'), protocol=5) #save model as a pickled file
